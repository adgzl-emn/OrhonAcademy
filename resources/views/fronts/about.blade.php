...
@section('content')
        ...
        <div class="bg-dark page-header">
            <div class="container text-center">
                <h1 class="text-white animated zoomIn mb-3">@lang('menu.hakkımızda')</h1>
            </div>
        </div>
    </div>
    <!-- Navbar & Hero End -->
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                    <img class="img-fluid" src="{{asset('front3')}}/img/about.png">
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-inline-block border rounded-pill text-dark px-4 mb-3">About Us</div>
                    <h2 class="mb-4">@lang("hakkimizda.altbaslik")</h2>
                    <p class="mb-4">@lang("hakkimizda.icerik")</p>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <img class="img-fluid rounded-circle w-100 mb-4" src="{{asset('front3')}}/img/team-1.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <h5>Full Name</h5>
                        <p class="mb-4">Designation</p>
                        <img class="img-fluid rounded-circle w-100 mb-4" src="{{asset('front3')}}/img/team-2.jpg" alt="">
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <h5>Full Name</h5>
                        <p class="mb-4">Designation</p>
                        <img class="img-fluid rounded-circle w-100 mb-4" src="{{asset('front3')}}/img/team-3.jpg" alt="">
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <h5>Full Name</h5>
                        <p class="mb-4">Emin</p>
                        <img class="img-fluid rounded-circle w-100 mb-4" src="{{asset('front3')}}/img/team-4.jpg" alt="">
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-square text-dark bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
