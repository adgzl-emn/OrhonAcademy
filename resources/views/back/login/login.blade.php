                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            <a class="text-center"> <h4>Orhon Academi Giriş</h4></a>
                            ...
                            <form class="mt-5 mb-5 login-input" method="post" action="{{route('login.post')}}">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Kullanıcı Adı" name="name">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="Şifre" name="password">
                                </div>
                                <button type="submit" class="btn login-form__btn submit w-100">Giriş</button>
                            </form>
