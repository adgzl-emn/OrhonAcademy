                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            ...
                            <a class="text-center"> <h4>Orhon Academy</h4></a>

                            <form class="mt-5 mb-5 login-input" method="post" action="{{route('back.add.user')}}">
                                @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control"  placeholder="Kullanıcı İsimi" name="name" required>
                                </div>
                                <div class="form-group">
